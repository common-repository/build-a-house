...
if ( ! class_exists( 'iworks_rate' ) ) {
	class iworks_rate {
		...
		private function get_plugin_data_by_plugin_id( $plugin_id ) {
			...
			$plugin['url']         = esc_url(
				sprintf(
					_x( 'https://wordpress.org/plugins/%s', 'plugins home', 'build-a-house' ),
					$plugin['slug']
				)
			);
			$plugin['support_url'] = esc_url(
				sprintf(
					_x( 'https://wordpress.org/support/plugin/%s', 'plugins support home', 'build-a-house' ),
					$plugin['slug']
				)
			);
			return $plugin;
		...
		public function filter_get_advertising_og( $data ) {
			return array(
				'iworks-adverting-og' => array(
					'title'    => __( 'OpenGraph', 'build-a-house' ),
		...
		public function get_advertising_og_content() {
			$args = array(
				...
				'plugin_name'        => __( 'OG — Better Share on Social Media', 'build-a-house' ),
				'plugin_wp_home'     => __( 'https://wordpress.org/plugins/og/', 'build-a-house' ),
			);
